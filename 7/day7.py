...
#      Normally, they use big machines to move the rocks and filter the sand, but the machines
#        have broken down because Desert Island recently stopped receiving the parts they need to fix the machines.
...
#  equal to its bid multiplied by its rank, where the weakest hand gets rank 1, the second-weakest hand gets rank 2,
#    and so on up to the strongest hand. Because there are five hands in this example, the strongest hand
