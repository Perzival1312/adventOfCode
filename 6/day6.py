...
# the time allowed for each race and also the best distance ever recorded in that race.
#    To guarantee you win the grand prize, you need to make sure you go farther
...
# with a big button on top. Holding down the button charges the boat, and releasing
#  the button allows the boat to move. Boats move faster if their button was held longer,
#  but time spent holding the button counts against the total race time.
#  You can only hold the button at the start of the race, and boats don't
...
# start of the race. The boat won't move; it will have traveled 0 millimeters by the end of the race.
...
#    different ways you could win: you could hold the button for 2, 3, 4, or 5 milliseconds at the start of the race.
