...
# once the sun rises and heats up the sand, you might be able to use
...
# If that sequence is not all zeroes, repeat this process, using the sequence you just
# generated as the input sequence. Once all of the values in your latest sequence are zeroes,
...
# Since these values aren't all zero, repeat the process: the values differ by 0 at each step, so the
# next sequence is 0 0 0 0. This means you have enough information to extrapolate the history! Visually,
