...
# is farthest from the starting position. Because the animal is in the pipe,
# it doesn't make sense to measure this by direct distance. Instead, you need to find
# the tile that would take the longest number of steps along the loop to reach from the starting point
